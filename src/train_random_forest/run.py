...
def go(args):
    ...
    artifact = args.trainval_artifact;
    trainval_local_path = run.use_artifact(artifact).file()# YOUR CODE HERE
    ######################################
    ...
    # YOUR CODE HERE
    ######################################
    signature_from_infer = mlflow.models.infer_signature(X_val, y_pred)
    mlflow.sklearn.save_model(
        sk_pipe,
        "random_forest_dir",
        serialization_format=mlflow.sklearn.SERIALIZATION_FORMAT_CLOUDPICKLE,
        signature=signature_from_infer,
